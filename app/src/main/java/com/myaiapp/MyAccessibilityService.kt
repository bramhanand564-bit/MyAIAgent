...
class MainActivity : AppCompatActivity() {
    ...
    // === NEW: MULTI-STEP ACTION EXECUTOR ===
    private fun executeAndroidAction(jsonString: String) {
        // हम एक Coroutine शुरू कर रहे हैं ताकि हर स्टेप के बीच में AI रुक (wait) सके
        CoroutineScope(Dispatchers.Main).launch {
            try {
                // AI अब एक Array [...] भेजेगा
                ...
                val jsonArray = if (arrayStart != -1 && arrayEnd != -1) {
                    ...
                    // अगर AI गलती से सिर्फ एक ऑब्जेक्ट {...} भेज दे, तो उसे Array में बदल दो
                ...
                // AI के बनाए हुए सारे स्टेप्स एक-एक करके चलाओ!
                for (i in 0 until jsonArray.length()) {
                    ...
                    when (action) {
                        "open_app" -> {
                            ...
                            delay(3000) // ऐप खुलने का इंतज़ार (3 सेकंड)
                        }
                        "wait" -> {
